...
public class DefaultSceneService implements SceneService {
	...
	public List<Scene> fetchScenesByPart(String characterName, String musicalName) {
		log.info("fetchScenesByPart has been called for characterName={}, musicalName={}", characterName, musicalName);
		
		return sceneDao.fetchScenesByPart(characterName, musicalName);
